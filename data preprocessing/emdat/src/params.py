...
#Fearures about data quality
featurelist = ["largest_data_gap", "proportion_valid", "proportion_valid_fix", "length_invalid" ]
        
#Overall gaze features to generate and export
featurelist.extend( ['numsegments','length','numsamples','numfixations','fixationrate','meanabspathangles',
...
aoinames = ['High','Low','Med']
aoinames = ['Formula','Title','Chemistry','Picture','Chart', 'Text', 'Data']
#aoinames = ['Formula_High','Title_Low','Chemistry_Low','Title_Med','Picture_Low', 'Chart_Low', 'Text_Low', 'Picture_Med', 'Text_Med', 'Chemistry_Med', 'Title_High', 'Chemistry_High', 'Text_High', 'Picture_High', 'Chart_High', 'Data_High']
aoinames = ['Title','Content']
...
aoiproportion = ['proptransfrom_' + x for x in aoinames]
...
#    aoifeaturelist.extend(map(lambda x:aoin+'_'+x, aoitransfrom))
    for prop in aoiproportion:
        aoifeaturelist.append(aoin + '_' + prop)
