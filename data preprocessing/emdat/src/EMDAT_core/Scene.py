...
#            print "seglist",seglist
        ...
        self.features["largest_data_gap"] = self.largest_data_gap
        self.features["proportion_valid"] = self.proportion_valid
        self.features["proportion_valid_fix"] = self.proportion_valid_fix
        self.features["length_invalid"] = sumfeat(segments,"features['length_invalid']")
